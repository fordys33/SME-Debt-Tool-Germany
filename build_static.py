    ...
    try {{
        ...
        switch ('{func_name}') {{
            case '{func_name}':
                ...
                }} else if ('{func_name}' === 'cost-analysis') {{
                ...
                }} else if ('{func_name}' === 'debt-snowball') {{
                ...
                }} else if ('{func_name}' === 'funding-guidance') {{
                    result = {{
                ...
                }} else if ('{func_name}' === 'covenant-tracking') {{
