...
exports.handler = Handler(async (event, context) => {
    ...
    try {
        ...
        switch ('covenant-tracking') {
            case 'covenant-tracking':
                if ('covenant-tracking' === 'debt-brake') {
                    result = {
                ...
                } else if ('covenant-tracking' === 'cost-analysis') {
                ...
                } else if ('covenant-tracking' === 'debt-equity') {
                ...
                } else if ('covenant-tracking' === 'debt-snowball') {
                ...
                } else if ('covenant-tracking' === 'funding-guidance') {
                    result = {
                ...
                } else if ('covenant-tracking' === 'covenant-tracking') {
