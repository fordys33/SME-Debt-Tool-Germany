    ...
    try {
        ...
        switch ('debt-brake') {
            case 'debt-brake':
                ...
                } else if ('debt-brake' === 'cost-analysis') {
                ...
                } else if ('debt-brake' === 'debt-equity') {
                ...
                } else if ('debt-brake' === 'debt-snowball') {
                ...
                } else if ('debt-brake' === 'funding-guidance') {
                    result = {
                ...
                } else if ('debt-brake' === 'covenant-tracking') {
