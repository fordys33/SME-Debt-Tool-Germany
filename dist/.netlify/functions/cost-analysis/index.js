    ...
    try {
        ...
        switch ('cost-analysis') {
            case 'cost-analysis':
                ...
                } else if ('cost-analysis' === 'cost-analysis') {
                ...
                } else if ('cost-analysis' === 'debt-equity') {
                ...
                } else if ('cost-analysis' === 'debt-snowball') {
                ...
                } else if ('cost-analysis' === 'funding-guidance') {
                    result = {
                ...
                } else if ('cost-analysis' === 'covenant-tracking') {
