    ...
    try {
        ...
        switch ('debt-equity') {
            case 'debt-equity':
                ...
                } else if ('debt-equity' === 'cost-analysis') {
                ...
                } else if ('debt-equity' === 'debt-equity') {
                ...
                } else if ('debt-equity' === 'debt-snowball') {
                ...
                } else if ('debt-equity' === 'funding-guidance') {
                    result = {
                ...
                } else if ('debt-equity' === 'covenant-tracking') {
