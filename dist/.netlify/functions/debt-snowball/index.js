...
exports.handler = Handler(async (event, context) => {
    ...
    try {
        ...
        switch ('debt-snowball') {
            case 'debt-snowball':
                if ('debt-snowball' === 'debt-brake') {
                    result = {
                ...
                } else if ('debt-snowball' === 'cost-analysis') {
                ...
                } else if ('debt-snowball' === 'debt-equity') {
                ...
                } else if ('debt-snowball' === 'debt-snowball') {
                ...
                } else if ('debt-snowball' === 'funding-guidance') {
                    result = {
                ...
                } else if ('debt-snowball' === 'covenant-tracking') {
